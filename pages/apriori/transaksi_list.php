...
<section class="content">
    <div class="row">
        ...
        <!-- <select id="nama" class="form-control selBox" required="required">
         <?php $load = mysqli_query($link, "SELECT * FROM tbl_data"); ?>
            <?php while ($barang = mysqli_fetch_assoc($load)){
                echo "<option value='$barang[id_barang]'>$barang[nmb]</option>";
            }
            ?> --> 
